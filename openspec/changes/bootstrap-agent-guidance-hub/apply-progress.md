...
- PR10E adds `agh pack init` for local pack template scaffolding. By default it creates only `agh.pack.toml`, `instructions/`, and `skills/`; flags can customize version/description and optionally create `AGENTS.md`, `CLAUDE.md`, or one or more `skills/<name>/SKILL.md` starter files.
