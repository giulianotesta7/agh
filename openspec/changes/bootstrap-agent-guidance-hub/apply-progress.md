...
- PR10A release readiness audit found core technical checks passing (`pytest`, `ruff`, lockfile, CLI entrypoint, Dockerfile syntax) and added `docs/release-checklist.md` for pre-tag validation. Remaining pre-0.1.0 work includes public installer without clone, skill-only packs, `agh pack init`, release docs updates, and explicit decisions on agent selection and API error envelope.
