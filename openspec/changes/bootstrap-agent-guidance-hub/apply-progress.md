...
- PR10C adds CI-only GitHub Actions validation on pull requests and pushes to `main`: lockfile check, tests, Ruff lint, Ruff format check, Pyright, Dockerfile check, and package build. It intentionally does not publish packages or Docker images.
