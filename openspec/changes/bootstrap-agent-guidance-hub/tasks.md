...
- [ ] 2.1 Add `agh/common/ids.py`, `validation.py`, `repo_url.py`, `pack_manifest.py`, `checksums.py` with unit tests for prefixed IDs, email, slug/SemVer/latest, URL normalization, and managed payload hashes.
